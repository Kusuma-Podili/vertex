...
/**
 * AURA Engineering Philosophy, Heritage & Cleanroom Labs
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="border-b border-slate-800 pb-8 mb-12">
        ...
        <h1 className="text-3xl font-extrabold text-white mt-2">AURA Engineering Philosophy, Heritage & Cleanroom Labs</h1>
