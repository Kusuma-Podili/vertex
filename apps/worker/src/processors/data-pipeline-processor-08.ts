...
export interface DataBatchJob08 {
  batchId: string;
  sourceTopic: string;
...
export class BackgroundDataPipelineProcessor08 {
  private logger = new EnterpriseLogger('DataPipelineProcessor08');

  async executeBatchProcessing(job: DataBatchJob08) {
