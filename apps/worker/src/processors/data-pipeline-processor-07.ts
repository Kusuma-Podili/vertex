...
export interface DataBatchJob07 {
  batchId: string;
  sourceTopic: string;
...
export class BackgroundDataPipelineProcessor07 {
  private logger = new EnterpriseLogger('DataPipelineProcessor07');

  async executeBatchProcessing(job: DataBatchJob07) {
