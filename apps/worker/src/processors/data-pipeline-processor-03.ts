...
export interface DataBatchJob03 {
  batchId: string;
  sourceTopic: string;
...
export class BackgroundDataPipelineProcessor03 {
  private logger = new EnterpriseLogger('DataPipelineProcessor03');

  async executeBatchProcessing(job: DataBatchJob03) {
