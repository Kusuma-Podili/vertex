...
export interface DataBatchJob02 {
  batchId: string;
  sourceTopic: string;
...
export class BackgroundDataPipelineProcessor02 {
  private logger = new EnterpriseLogger('DataPipelineProcessor02');

  async executeBatchProcessing(job: DataBatchJob02) {
